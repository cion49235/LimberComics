...
import co.cartoon.fun.comics.Activity.BrowserActivity;
...
import co.cartoon.fun.comics.Unit.NotificationUnit;
import co.cartoon.fun.comics.Unit.RecordUnit;
import co.cartoon.fun.comics.Unit.ViewUnit;
import co.cartoon.fun.comics.View.NinjaContextWrapper;
